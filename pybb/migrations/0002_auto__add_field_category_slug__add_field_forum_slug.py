...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pybb_category', 'slug', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'Forum.slug'
        db.add_column('pybb_forum', 'slug', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True, null=True, blank=True), keep_default=False)
